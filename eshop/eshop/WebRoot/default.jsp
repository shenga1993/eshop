...
<script language="javascript" type="text/javascript"> 
	...
	links='|||';
	texts='全城疯狂网购大促销1……|全城疯狂网购大促销2……|全民商城网购时代的开启……|网购商城改变我们的生活';
			...
			<div class="info_con">
				<ul>
				  ...
				  <li>
					<div>
						<div class="info_text">
							<s:a href="page_queryGoods.action?paramsGoods.goods_id=%{#goods.goods_id}" target="_blank" title="%{#goods.goods_name}">
								<s:property value="#goods.goods_name.length()>25?#goods.goods_name.substring(0,24)+'...':#goods.goods_name"/>
							</s:a>
						</div>
						<div class="info_time">[<s:property value="#goods.goods_date.substring(0,10)"/>]</div>
					</div>
				  </li>
				  </s:iterator>
				</ul>
