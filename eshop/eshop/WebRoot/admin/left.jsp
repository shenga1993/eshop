			  ...
			  <tr>
				...
				<div id="container">
				 ...
				 <h1 class="type"><a href="javascript:void(0)">配送员管理</a></h1>
				  ...
				  <c:if test="${admin.user_type==3 }">
				  <h1 class="type"><a href="javascript:void(0)">常见帮助管理</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
					...
					<ul class="MM">
					  <li><a href="Admin_listInfos.action" target="MainFrame">常见帮助查询</a></li>
					  <li><a href="Admin_addInfoShow.action" target="MainFrame">新增常见帮助</a></li>
					</ul>
				  </div>
				  </c:if>
