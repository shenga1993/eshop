...
<title><s:if test="#attr.info!=null && #attr.info.info_id!=0">编辑</s:if><s:else>发布</s:else>常见帮助</title>
...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">常见帮助管理&gt;&gt;<s:if test="#attr.info!=null && #attr.info.info_id!=0">编辑</s:if><s:else>发布</s:else>常见帮助</span>
</div>
     ...
     <td height="24">
       <Table border="0" cellspacing="0" cellpadding="0" align="center" width="100%"> 
            <TR>
              ...
              <TD class="edittitle"><s:if test="#attr.info!=null && #attr.info.info_id!=0">编辑</s:if><s:else>发布</s:else>常见帮助</TD>
   ...
   <tr>
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
        ...
        <tr> 
          ...
          <td>
            <textarea style="width:350px;height:250px" name="paramsInfo.info_content"  id="noticeContent"><s:property value="#attr.info.info_content" escape="false"/></textarea>
          </td>
        </tr>   
     </table>  
     </td> 
