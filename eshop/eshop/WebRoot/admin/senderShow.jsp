  ...
  <tr>
    ...
    <td width="" align="right">
      ...
      <input type="text" id="paramsUser.real_name" name="paramsUser.real_name" value="${paramsUser.real_name}" class="inputstyle"/>&nbsp;
            状态：
      <s:select id="paramsUser.user_flag" name="paramsUser.user_flag" value="%{#attr.paramsUser.user_flag}" 
      		list="#{'1':'配送中','2':'无任务' }" listKey="key" listValue="value" 
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <tr class="<s:if test='(#status.index + 1)%2==0'>list1</s:if><s:else>list0</s:else>" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center"><s:property value="#user.user_flagDesc"/></td> 
     <td width="" align="center"><s:property value="#user.reg_date.substring(0,10)"/></td>  
     <td width="" align="center">
       <img src="images/edit.png"/>&nbsp;<s:a href="Admin_editSender.action?paramsUser.user_id=%{#user.user_id}">编辑</s:a>
     </td>
   </tr> 
   </s:iterator>
   </s:if>
