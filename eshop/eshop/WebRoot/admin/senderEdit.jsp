...
<title><s:if test="#attr.user!=null && #attr.user.user_id!=0">编辑</s:if><s:else>添加</s:else>配送员信息</title>
...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">配送员管理&gt;&gt;<s:if test="#attr.user!=null && #attr.user.user_id!=0">编辑</s:if><s:else>添加</s:else>配送员</span>
</div>
     ...
     <td height="24">
       <Table border="0" cellspacing="0" cellpadding="0" align="center" width="100%"> 
            <TR>
              ...
              <TD class="edittitle"><s:if test="#attr.user!=null && #attr.user.user_id!=0">编辑</s:if><s:else>添加</s:else>配送员</TD>
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
       ...
       <tr> 
        ...
        <tr>
          ...
          <td>
            <s:select list="#{'1':'配送中',2:'无任务' }" id="paramsUser.user_flag" name="paramsUser.user_flag" value="%{#attr.user.user_flag}"
