...
public class UserDao {
	...
	public int addUser(User user, Connection conn){
		String sql = "INSERT INTO user(user_id,user_name,user_pass,real_name,user_sex,nick_name,user_address,user_mail,user_phone,user_flag,reg_date,user_type) values(null,?,?,?,?,?,?,?,?,?,?,?)";
	...
	public int updateUser(User user, Connection conn){
		...
		if (user.getUser_flag()!=0) {
			sBuilder.append(" ,user_flag =" + user.getUser_flag() +" ");
		}
	...
	public List<User>  listUsers(User user, Connection conn){
		...
		if (user.getUser_flag()!=0) {
			sBuilder.append(" and user_flag =" + user.getUser_flag() +" ");
		}
		if (user.getUser_type()!=0) {
			sBuilder.append(" and user_type =" + user.getUser_type() +" ");
		}
